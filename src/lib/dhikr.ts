...
const Dhikr = { 
    [DhikrType.MORNING]: {
        "dhikr.morningdua": {
            "arabic": "أَصْبَحْتُ أُثْنِيْ عَلَيْكَ حَمْدًا ، وَأَشْهَدُ أَنْ لَّا إِلٰهَ إِلَّا اللهُ",
        ...
        "dhikr.blessedday": {
            "arabic": "أًصباحنا وأصبح الملك لله ربي العالمين، اللهم إنني أسأل خير هذا اليوم، فتحه ونصره ونوره وبركته وهده، وأعوذ بك من شر ما فيه وما بعداه",
            "translationlocale": "dhikr.blesseddaytranslation"
        },
        "dhikr.enteringmorning": {
            "arabic": "اًللهم بك أصبحنا وبك أمسينا وبك نحيينا وبك نموت وإليك المصير",
    ...
    [DhikrType.EATING]: { 
        ...
        "dhikr.afterbreakingfast1": {
            ...
            "translationlocale": "dhikr.afterbreakingfast1translation1"
        },
